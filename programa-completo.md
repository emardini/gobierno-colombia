...
| Identidad | Del "país de narcos" — narrativa que Colombia exporta involuntariamente. | Del "país de narcos" al "Tigre Andino Democrático" — país que exporta instituciones, cacao, biotecnología y patrulleras. | La narrativa cambia cuando los resultados verificables superan los estereotipos. Empieza en los nodos. |
...
|---|---|---|
| Giro directo automático en salud (fin del carámbano hospitalario) | Todo hospital del país | Frente VI |
...
## B. Ejecución presupuestal — eliminar el carámbano de fin de año
...
| (−) Valor producido por brigadas (catastro, agua) | — | $0.5–0.8 B | $2–3 B | Ahorra contratistas externos |
| (−) Subsidios familiares desplazados | — | $0.3–0.5 B | $1–1.5 B | El servicio reemplaza transferencias no contributivas |
...
| % ejecución de inversión al 30 de junio | Capacidad ejecutoria | % al 31 de diciembre (siempre alto por el carámbano) | MinHacienda | Mensual |
...
| Un sucesor con mejor evidencia no puede corregir | — | **Sunset por fracaso (3.4.2): rampa de salida legítima que distingue corrección de abandono** |
