> **META.** Nota editorial sobre la versión y su trazabilidad.
...
3. **Irreversibilidad simétrica.** Al protocolo de graduación por éxito se le agrega un *caducidad por fracaso*: rampa de salida legítima y transparente para desmontar un nodo que incumple sus métricas pre-registradas. El blindaje protege contra la reversión por capricho, no contra la corrección por evidencia.
