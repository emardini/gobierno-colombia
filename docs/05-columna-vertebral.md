...
| Cambio de gobierno que quiere mover nodos | Puede seleccionar nuevos nodos con el mismo IPN. No puede cancelar nodos en Fase 1 o 2 sin costos contractuales, salvo por la vía de *caducidad por fracaso* (3.4.3). | Moverse es más barato que quedarse solo para nodos no empezados; una vez empezado, el costo de salida supera el beneficio político de cancelar, excepto cuando la evidencia justifica la salida. |
...
|---|---|---|---|
| **Ley de Régimen de Nodos** | Criterios técnicos (DANE), fases, indicadores, reglas de graduación **y de caducidad por fracaso**. Define la autoridad estatutaria del Gerente. | **Año 1** (adelantada) | Mayoría en Congreso para derogar; la coalición de beneficiarios la defiende. |
...
### 3.4.3 Caducidad por fracaso: la rampa de salida legítima (nuevo)
...
| Efecto sobre contratos | La salida justificada por caducidad **reduce o exime la penalidad contractual** que aplicaría a una cancelación arbitraria. Las concesiones de largo plazo solo existen sobre nodos que pasaron Fase 1, de modo que el caso de caducidad recae sobre compromisos aún reversibles. |
...
El caducidad tiene un flanco peligroso que hay que cerrar de frente. Concentrar el Estado en pocos municipios crea, por diseño, blancos de alto valor: a un grupo armado le puede convenir sabotear un nodo (atacar la obra, asesinar al líder, forzar el desplazamiento) precisamente para que incumpla sus métricas y se declare fracasado. Si el caducidad no distingue el fracaso por sabotaje del fracaso por mal diseño, le enseña al actor armado que disparar es la forma de matar el programa, y convierte una herramienta de honestidad en un premio a la violencia. La regla que lo evita: cuando un nodo incumple sus métricas y la causa verificada es la acción armada deliberada, no se activa el caducidad, se activa el plan de contingencia de seguridad del Frente III y el refuerzo del equipo (coherente con la regla de deterioro en Fase 1 de 3.3.4). El caducidad se reserva para el fracaso del modelo con seguridad estable: cuando el Estado pudo operar y aun así el nodo no prendió. El tercero independiente que verifica el caducidad debe pronunciarse explícitamente sobre esta distinción antes de que cualquier desmonte proceda.
