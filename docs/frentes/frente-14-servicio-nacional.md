...
**La objeción de conciencia es la única salida del componente de armas.** Lo predeterminado es que todo el que sirve aprende a disparar a nivel básico y táctica básica, sin importar la modalidad. Quien objeta por conciencia queda exento del componente de armas de fuego y táctica, y hace el resto (defensa personal, primeros auxilios, seguridad), sin penalización ni pérdida de estatus ni de beneficios. Esto no es un detalle: es lo que preserva intacta la defensa jurídica de todo el servicio universal. La Corte trata la objeción como derecho fundamental, y el plan sostiene la universalidad sobre el argumento de que existe una salida genuina para el que no quiere empuñar un arma. Que el entrenamiento con armas sea lo predeterminado para la enorme mayoría es defensible siempre que la puerta de la objeción esté abierta de verdad y no se castigue al que la usa; cerrar esa puerta sería lo que haría caer el argumento en corte.
...
| Salario + prestaciones | $0,15-0,3 billones | $0,9-1,5 billones | $3-4,5 billones | 1 SMMLV + 30% |
| Bono Familiar (SISBEN A+B) | $0,05-0,1 billones | $0,3-0,5 billones | $0,8-1,2 billones | ~30% en A+B |
| Alimentación, alojamiento, equipamiento | $0,1-0,2 billones | $0,6-1 billones | $2-3 billones | Parte aprovecha infraestructura FFMM |
| **Costo bruto** | **$0,3-0,6 billones** | **$1,8-3 billones** | **$5,8-8,7 billones** | |
| (−) Valor producido por brigadas (catastro, agua) | n/a | $0,5-0,8 billones | $2-3 billones | Ahorra contratistas externos |
| (−) Subsidios familiares desplazados | n/a | $0,3-0,5 billones | $1-1,5 billones | El servicio reemplaza transferencias no contributivas |
| **Costo neto presupuesto adicional** | **$0,3-0,6 billones** | **$1,0-2,2 billones** | **$2,8-5,2 billones** | ~0.2-0.4% del PIB en Año 3 |
