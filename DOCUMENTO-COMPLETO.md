...
### III.8.3 Contrainteligencia y soberanía: el flanco vacío

Aquí está el hueco más grande y el que tú señalas con razón. Fuentes del propio Estado admiten que el contraespionaje en Colombia "prácticamente no existe": operan en el país agentes de decenas de servicios extranjeros, y no hay ni siquiera la obligación de que reporten su presencia. La DEA llegó a interceptar tráfico de internet colombiano a través de los proveedores locales; salas de interceptación operaron con patrocinio externo. La soberanía en inteligencia, que tú quieres total, hoy es más bien una ficción.

| Mecanismo | Diseño | Por qué |
|---|---|---|
| Contrainteligencia de verdad | Una capacidad real, dentro de la DNI, dedicada a detectar y neutralizar operaciones de inteligencia extranjeras en territorio colombiano, sean de un rival o de un aliado; el interés nacional no se asume alineado con nadie por defecto | Hoy se asume que el aliado no espía, y el aliado espía |
| Registro y regla para servicios extranjeros | Marco que obligue a los servicios extranjeros a declarar su presencia y sus acuerdos de cooperación, y que prohíba la operación no declarada en suelo colombiano | No se puede contrarrestar lo que no se reconoce que está |
| Soberanía tecnológica | Reducir la dependencia de software y hardware extranjeros para inteligencia (la misma dependencia que trajo Pegasus y Hacking Team), desarrollando capacidad nacional y auditando toda herramienta importada; la herramienta comprada afuera es a la vez un riesgo de soberanía y un vector de abuso | Quien te vende el sistema de espiar puede espiarte a ti |
| Protección del dato del Estado | Blindaje de las bases de datos y comunicaciones del propio Estado frente a la penetración extranjera, articulado con la ciberdefensa | La mejor inteligencia no sirve si el adversario ya está adentro |
...
| Auditoría de la tecnología importada | Toda tecnología crítica que se compra afuera se audita antes de instalarse, para no repetir el caso de las herramientas con puerta trasera (Pegasus, Hacking Team); es el mismo principio de soberanía tecnológica de la contrainteligencia (III.8.3) | Decreto + certificación |
...
**Última actualización:** 2026-07-17 00:12:06