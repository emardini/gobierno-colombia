...
- **El paquete se vuelve separable, no todo o nada**: los beneficios materiales (bonificación, mentor, caja de vidrio del Fomag, becas) se implementan de forma incondicional, sin esperar a que el gremio acepte la recalibración de la evaluación, que queda como la única pieza sujeta a concertación.
- **La continuidad pedagógica no depende solo de la presencia diaria del maestro**: los materiales estructurados, el aprendizaje asistido por computador y el contenido offline, ya diseñados en 7.2 y 7.5, dan resiliencia sin que esto se use nunca como sustituto permanente del maestro ni como herramienta para romper un paro.
- **La alimentación escolar queda expresamente fuera de cualquier disputa laboral docente**: el PAE corre por la UApA y las alcaldías, no por la nómina docente.
- **Transparencia hacia la base afiliada, no solo hacia la dirigencia**: los beneficios concretos se publican con la misma lógica de datos abiertos del resto del plan, y la Comisión de Concertación queda como mesa permanente, no como reunión única, para que un rechazo de hoy no cierre la puerta para siempre.

## [1.54] Alimentación escolar, formación docente continua y la coalición con FECODE

- **Alimentación escolar (7.8) reescrita de cero**, a pedido explícito tras señalarse que era un punto débil. Verificado por web: el PAE dejó de ser el programa menor que el frente anterior sugería, es política de Estado desde 2025 (Ley 2183/2022 y su desarrollo), con cobertura de 76% (2022) a 85,5% (2026), presupuesto de $3,94B a $7,31B, y comida preparada en sitio de 57% a 78%. El frente ya no inventa el programa, cierra lo que falta: el 14,5% de cobertura restante, la minuta nutricional auditada contra lo servido, el 100% de comida preparada en sitio y la continuidad de PAE en Receso, todo priorizado primero en los nodos.
- **Formación continua docente (7.3.2), nueva**, responde a la pregunta de cómo asegurar que la calidad del maestro no se detenga en el concurso de ingreso. Conecta tres piezas que el MEN ya organiza bajo el Sistema Colombiano de Formación de Educadores (formación inicial vía acreditación de licenciaturas, formación en servicio vía el PTA rediseñado, formación avanzada vía becas de posgrado con compromiso de permanencia en zona), sin crear estructura nueva.
- **Plan de mejoramiento obligatorio entre la primera evaluación insatisfactoria y la segunda (7.3)**, a pedido explícito: la evaluación docente no busca depurar la planta, busca mejorarla, así que el año intermedio entre las dos evaluaciones que exige el Estatuto pasa a tener acompañamiento estructurado del maestro mentor, no queda en blanco.
- **Riesgo político de FECODE nombrado explícitamente (7.3)**, con mitigación de secuencia: activar primero lo que no genera choque (bonificación, mentor), llevar la recalibración de la evaluación a la Comisión Nacional de Concertación ya existente, en vez de decretarla sin mesa previa.
- **Coalición con el magisterio (7.3.3), nueva y la pieza más sustantiva de esta versión**: a pedido explícito de diseñar el frente para que FECODE tenga interés propio en apoyarlo, no solo tolerarlo. El hallazgo central, verificado por web: lo más urgente para el magisterio hoy no es el debate 1278/2277, es la crisis real del Fomag (reducción de 84% en la red de prestadores, patrimonio de +$1,2B a -$3B entre 2021 y 2025, más de 2.300 contratos sin auditoría, paro nacional en abril de 2026). El plan ofrece la caja de vidrio que ya diseñó para el Frente VI (giro directo, trazabilidad, auditoría) aplicada al Fomag a través de su propio Consejo Directivo, como la oferta más creíble y urgente, antes de pedir nada sobre evaluación docente.

## [1.53] Reconstrucción del Frente VII: Educación

- **El Frente VII pasó de cinco medidas genéricas a nueve secciones con mecanismo, responsable, vía jurídica y costeo**, el mismo nivel de detalle que ya tenía el resto del plan. Motivado por un señalamiento directo de que el frente educativo era el más débil del documento.
- **Diagnóstico actualizado con datos verificados por web**: Saber 11 sube desde la pandemia (250,2 en 2022 a 255,8 en 2025) pero la brecha urbano-rural creció 44% en doce años (18,5 a 26,7 puntos), la brecha oficial/no oficial creció de 19,9 a 27,5 puntos, y apareció una brecha de género de 9 puntos. NINI en ~20% (DANE) hasta 25% en la franja 18-24 según la OCDE (promedio OCDE 14%), con la caída reciente explicada más por demografía que por política. Graduación oportuna en pregrado público en 43%.
- **Núcleo pedagógico nuevo (7.2)**: rediseño del programa Todos a Aprender, que ya opera hace más de una década en 805 municipios, con los dos mecanismos de mayor retorno según la evidencia global 2025 (más de 200 evaluaciones de impacto en 52 países): pedagogía estructurada y enseñanza al nivel real del estudiante. Se crea el Índice de Brecha de Aprendizaje Territorial (IBAT), misma arquitectura que el IPN de nodos y el IBET étnico, para focalizar la tutoría de alta dosis.
- **Maestros (7.3)**: activa a fondo una potestad de dos décadas del Decreto 1278/2002 que nunca se usó a escala, bonificación rural, maestro mentor, evaluación que pesa el aula. Se agregó una comparación explícita con Estonia, Singapur y Vietnam (7.3.1), nombrando qué se adapta a un presupuesto ajustado y una democracia descentralizada, y qué no.
- **Formación en valores, integridad y método científico (7.4b), agregada a pedido explícito**: conecta tres piezas ya existentes que nunca se habían atado entre sí, la Cátedra de la Paz (obligatoria, Ley 1732/2014), los estándares de competencias ciudadanas y ciencias naturales, y el Programa Ondas de Minciencias (15 años, más de 4 millones de niños). Incluye el límite honesto de que la formación anticorrupción en la infancia no sustituye los candados del Frente XIII, y nombra explícitamente la tensión entre la pedagogía estructurada (medible, repetible) y la curiosidad genuina que Ondas protege manteniéndose voluntario y fuera de la evaluación estandarizada.
- **Educación superior (7.7)**: ata el crecimiento de cupos y gratuidad, ya real, a la acreditación del CNA y al seguimiento de empleabilidad del OLE, ambos ya existentes; focaliza el subsidio de interés de ICETEX, con el límite honesto de que eso deja sin ese beneficio a estudiantes de clase media que hoy lo tienen.
- **Ningún mecanismo nuevo del frente requiere ley**: todos caben en Decreto 1278/2002, Ley 115/1994, Ley 789/2002, Ley 30/1992 y Ley 1732/2014, o en programas que ya operan (PTA, Ondas, OLE, CNA). El costeo es, en su mayoría, redirección de un presupuesto sectorial que ya casi se dobló entre 2022 y 2024, no gasto nuevo.
